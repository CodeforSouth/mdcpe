class BusinessType
  ...
  LEISURE_TRAVEL_RECREATIONAL = self.new("Leisure, Travel & Recreational",
    [
      ...
      "Bar-Lounge-Night Club, Resturant/Cafet/Bar/Lounge/Night Club, Bar/Cocktail Lounge/Resturants, Recreational Courts - Club House, Cabana/Chickee/Gazebo/Club House/ Rec BDG,
      Short Term Event, Resturant-Cafeteria, Hotel, Motel, Gym/Exercise Club, Bowling Alley/Skating Rink"
      )
